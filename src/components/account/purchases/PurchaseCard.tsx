...
export const PurchaseCard: FC<PurchaseCardProps> = ({
  title,
  price,
  description,
  image
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[25px] right-6 z-20">
        <div 
          className="flex justify-center items-center min-w-[65px] h-[26px] px-[8px] py-[4px] bg-white rounded-[6px_16px] shadow-sm transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] group-hover:-translate-y-1"
        >
          <div 
            className="font-unbounded font-bold text-[14px] leading-[18px] text-center whitespace-nowrap"
            style={{
              color: '#5A0973'
            }}
          >
